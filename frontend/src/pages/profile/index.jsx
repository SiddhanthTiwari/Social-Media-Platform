                ...
                {authState.user && userProfile.userId &&
                    <div className={styles.container}>
                        <div className={styles.backDropContainer}>
                            ...
                            <img src={`${BASE_URL}/${userProfile.userId.profilePicture}`} alt='Profile Picture' />
                        </div>
                                ...
                                userProfile.education.map((edu, index) => {
                                    return (
                                        <div key={index} className={styles.EducationCard}>
                                            ...
                                            <p style={{marginTop:"0.2rem"}}>{edu.degree}</p>
                                            <p style={{marginTop:"0.2rem"}}>{edu.fieldOfStudy}</p>
                                        </div>
                                    )
                                })
                            }
                            <button className={styles.addEduButton} onClick={()=>{
                    ...
                    className={styles.commentsContainer}>
                        ...
                        className={styles.allCommentsContainer} >
                            <input onChange={EducationData} name='school' className={styles.inputField} type='text' placeholder='Enter School'/>
                            <input onChange={EducationData} name='degree' className={styles.inputField} type='text' placeholder='Enter Degree'/>
                            <input onChange={EducationData} name='fieldOfStudy' className={styles.inputField} type='text' placeholder='Field Of Study'/>
